...
export const MOCK_CUSTOMERS: Customer[] = [
  {
    ...
    travelPurpose: 'Summer Family Vacation',
    previousVisaHistory: 'UK Tourist Visa 2024 (Valid), UAE Tourist Visa 2023',
    previousRefusals: 'None',
    leadSource: 'TikTok',
    notes: 'Client requested fast-track document processing for Schengen submission.',
    createdAt: '2026-08-10'
  },
  {
    id: 'cust-2',
    customerId: 'ARS-2026-00002',
    ...
    bankBalance: 3200000,
    applyingCountry: 'United Kingdom',
    visaCategory: 'Student',
    travelPurpose: 'MSc Business Analytics Study',
    previousVisaHistory: 'Singapore 2022',
    previousRefusals: 'None',
    leadSource: 'Instagram',
    notes: 'Awaiting CAS letter from University of London.',
    createdAt: '2026-07-28'
  },
  {
    id: 'cust-3',
    customerId: 'ARS-2026-00003',
    ...
    travelPurpose: 'Trade Expo & Business Meetings',
    previousVisaHistory: 'USA B1/B2 2023, Schengen 2022',
    previousRefusals: 'Canada 2019 (Insufficient Ties)',
    leadSource: 'Walk-in',
    notes: 'Requires detailed business cover letter and property asset documents.',
